"""
Final OG image renderer for /partneri-zmeny/.

Builds 1200×630 OG with sapphire+marigold brand layout on a cleaned
blueprint background.

Brief sequence:
  1. Inpaint marigold dot from full-res source → _og_background_clean.png
  2. Crop / resize to 1200×630
  3. Logo pill (top-left, sapphire 95%)
  4. Headline (2 lines) + subheadline
  5. CTA pill (marigold bg, sapphire text)
  6. Footer: marigold dot bullet + URL + slogan
  7. Export og-image.png
  8. Pre-flight checks
"""
...
OUT = os.path.join(DIR, "og-image.png")
...
def step4_headline(canvas):
    ...
    headline_lines = ["Reformy nevznikajú", "v deň volieb."]
    y = 170
...
def step6_footer(canvas):
    ...
    text_draw.text((110, 548), "healthy-future.sk/partneri-zmeny",
                   font=font_url, fill=SAPPHIRE, anchor="lt")

    # Slogan — Nunito Regular, pred-launch bump 20 → 23 (+15 %), sapphire @ 70 %
    ...
    slogan_draw.text((110, 585), "Fakty a činy. Reformy pre Slovensko.",
...
def main():
    ...
    thumb_path = os.path.join(DIR, "_thumb_simulation.png")
